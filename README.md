# Data Science Mentorship Program - Week 3 Live Demo
...
This repository contains the code and data for our Week 3 live session. The goal of this demo is to ask key questions about the data and also perform data science reporting.

---

## ❓ Key Questions asked

The following important questions where asked:
1. How does hours worked per week influence the likelihood of earning over or less than $50K per year?
2. How does education level impact the likelihood of earning over or less than $50K per year?
3. Is there a significant income gap between genders?
4.  Which occupations have the highest earning potential?
5. How does marital status and relationship role influence income?
...
1.  **Clone the repo:**
    ```sh
    git clone [https://github.com/Oluwatobi-coder/Leapstart-Mentorship-Program-2.0-Data-Science-Group-3rd-Week-Live-Demo.git](https://github.com/Oluwatobi-coder/Leapstart-Mentorship-Program-2.0-Data-Science-Group-3rd-Week-Live-Demo.git)
    ```
2.  **Navigate to the project directory:**
    ```sh
    cd Leapstart-Mentorship-Program-2.0-Data-Science-Group-3rd-Week-Live-Demo
    ```
...
1.  Navigate to the `analysis_code/` directory:
    ...
    cd analysis_code
    ```
2.  Open the `data_analysis_2.ipynb` notebook file located in the `analysis_code/` directory.
3.  Run each cell.
